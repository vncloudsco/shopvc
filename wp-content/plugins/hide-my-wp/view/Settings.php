                            ...
                            if (!HMW_Classes_Tools::getOption('logout') && !HMW_Classes_Tools::getOption('error')) { ?>
                                <div id="wp_check">
                                    <div class="col-md-12 text-center">
                                        <button id="hmw_checksite" data-url="<?php echo home_url() ?>" data-token="ea8e9fa0-5453-11e8-89f3-0f78e432184f" class="btn btn-warning btn-lg"><?php _e("Check Your Website Vulnerability", _HMW_PLUGIN_NAME_) ?></button>
                                        <div class="wp_results"></div>
                                        <?php
                                        echo '<script type="text/javascript">
                                          var hmwQuery = {
                                            "ajaxurl": "' . admin_url('admin-ajax.php') . '",
                                            "nonce": "' . wp_create_nonce(_HMW_NONCE_ID_) . '"
                                          }
                                      </script>';
                                        ?>
                                    </div>
