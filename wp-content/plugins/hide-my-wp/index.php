...
/*
  Copyright (c) 2016 - 2017, WPPlugins.
...
if (PHP_VERSION_ID >= 5100) {
    if (!class_exists('HMWP_Classes_ObjController')) {
        ...
        if (is_admin() || is_network_admin()) {
            ...
            add_action('init', array(HMW_Classes_ObjController::getClass('HMW_Classes_FrontController'), 'runFrontend'),99);
        }
    }
} else {
    /* Main class call */
